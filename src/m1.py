...
class CircleChanger(object):
    ...
    def get_distance_from(self, point):
        ...
        ################################################################
        x=self.circle.center
        return x.get_distance_from(point)
    ...
    def swallow(self, other_circle_changer):
        ...
        centerX=(self.circle.center.x+other_circle_changer.circle.center.x)/2
        centerY=(self.circle.center.y+other_circle_changer.circle.center.y)/2
        radius = self.get_distance_from(other_circle_changer.circle.center)/2
        output = CircleChanger(centerX,centerY,radius,"red",self.colors+other_circle_changer.colors)
        return output
    ...
    def change_to_next_color_in_tuple(self):
        ...
        ################################################################
        index = self.count%len(self.colors)
